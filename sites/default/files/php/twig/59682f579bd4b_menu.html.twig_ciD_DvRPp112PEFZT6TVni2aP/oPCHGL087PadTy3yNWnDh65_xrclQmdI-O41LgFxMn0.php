...
/* themes/stem_theme/templates/navigation/menu.html.twig */
class __TwigTemplate_c30d4dfb4393f9822e0df577a6e49b5b492e8a6782203bae95e9ebfcd1b827a7 extends Twig_Template
{
        ...
        try {
            ...
            if ((isset($context["items"]) ? $context["items"] : null)) {
                ...
                if (((isset($context["menu_level"]) ? $context["menu_level"] : null) == 0)) {
                    // line 33
                    echo "      <ul";
                    echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute((isset($context["attributes"]) ? $context["attributes"] : null), "addClass", array(0 => "nav menu menu-parent"), "method"), "html", null, true));
                    echo ">
    ";
                } else {
                    // line 35
...
$context["item"], "in_active_trail", array())) ? ("menu-item--active-trail") : ("")));
  ...
  ";
    ...
    {
        return "themes/stem_theme/templates/navigation/menu.html.twig";
    }
...
{% macro menu_links(items, attributes, menu_level) %}
  ...
  {% if items %}
    {% if menu_level == 0 %}
      <ul{{ attributes.addClass('nav menu menu-parent') }}>
    {% else %}
      <ul class=\"menu\">
    {% endif %}
    {% for item in items %}
